...
export interface ModelMethod {
  method: string;
  aliases?: string[];
  category: 'property' | 'relationship' | 'method' | 'scope' | 'accessor' | 'mutator';
  id: string;
  en: string;
}

export const modelData: ModelMethod[] = [
  // ============================================
 ...
 */
export const getModelHover = (keyword: string, lang: 'id' | 'en'): string | null => {
  const lowerKeyword = keyword.toLowerCase();
  
  const match = modelData.find(d => {
