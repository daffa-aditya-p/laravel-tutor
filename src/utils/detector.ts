...
/**
 * Tipe file Laravel yang didukung
 */
export type LaravelFileType = 'migration' | 'model' | 'controller' | 'route' | 'unknown';
 ...
 */
export function detectFileType(document: vscode.TextDocument): LaravelFileType {
 ...
 */
export function isPlainPhpFile(document: vscode.TextDocument): boolean {
 ...
 */
export function getFileTypeLabel(fileType: LaravelFileType): string {
  const labels: Record<LaravelFileType, string> = {
    migration: 'Migration',
    model: 'Model',
