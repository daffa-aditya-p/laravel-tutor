...
exports.getMigrationHover = exports.migrationData = void 0;
 ...
 */
const getMigrationHover = (keyword, lang) => {
    const lowerKeyword = keyword.toLowerCase();
    const match = exports.migrationData.find(d => {
        // Match exact method name
        if (d.method.toLowerCase() === lowerKeyword)
            return true;
        // Match keyword contains method
        if (lowerKeyword.includes(d.method.toLowerCase()))
            return true;
        // Match aliases
...
exports.getMigrationHover = getMigrationHover;
