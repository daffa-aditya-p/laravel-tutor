...
exports.LaravelChecklistPanel = void 0;
...
class LaravelChecklistPanel {
    ...
    _doUpdateWebview() {
      ...
      `);
        ...
        const fileType = (0, detector_1.detectFileType)(doc);
     ...
     */
    calculateScoreFromChecks(checks) {
        if (checks.length === 0)
            return 100;
        let score = 0;
        for (const check of checks) {
     ...
     * Migration checks
     */
    getMigrationChecks(text, messages) {
        return [
            {
     ...
     * Controller checks
     */
    getControllerChecks(text, messages) {
        return [
            {
...
exports.LaravelChecklistPanel = LaravelChecklistPanel;
LaravelChecklistPanel.viewType = 'laravelTutor.checklist';
